...
const issueApproval = {
  packageRules: [
    {
      managers: ["npm"],
      depTypeList: ["dependencies", "devDependencies", "optionalDependencies", "peerDependencies", "resolutions"],
      packagePatterns: ["*"],
...
/**
 * Override of packages to allow auto merging
 */
const allowedAutoMerge = {
  packageRules: [
    {
      managers: ["npm"],
      automerge: true,
